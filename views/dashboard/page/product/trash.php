<p>
    <a href="<?= URL ?>index.php/admin/productList/1"><button type="button" class="btn btn-secondary">Quay
            Lại</button></a>
...
<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td><a onclick="actionChange('Khôi phục','<?=URL ?>index.php/admin/retoreTempProduct/<?= $value['id'] ?>')"><img
                    class="icon" style="width:15px;" src="<?=URL ?>public\backend\images\rotate-right-solid.svg" /></a>
        </td>
        <td><a onclick="actionChange('Xóa luôn sản phẩm','<?=URL ?>index.php/admin/deleteProduct/<?= $value['id'] ?>')"><img
