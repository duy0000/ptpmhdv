...
<form action="<?= URL ?>index.php/admin/posteditorder/<?= $p['id'] ?>" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group">
        <label>Địa chỉ</label>
        <input type="text" value="<?= $p['address'] ?>" name="address" class="form-control"
            placeholder="Nhập tên sản phẩm">
    </div>
    <div class="form-group">
        <label>Ghi Chú</label>
        <input type="text" value="<?= $p['ghichu'] ?>" name="ghichu" disabled class="form-control"
            placeholder="Nhập tên sản phẩm">
    </div>
    <div class="form-group">
        <label>Tổng đơn</label>
        <input type="text" value="<?= $p['total'] ?>" name="product_name" disabled class="form-control"
            placeholder="Nhập tên sản phẩm">
    </div>
    <div class="form-group">
        <label>Ngày đặt hàng</label>
        <input type="text" value="<?=  $p['order_date'] ?>" name="product_name" disabled class="form-control"
            placeholder="Nhập tên sản phẩm">
    </div>
    <div class="form-group">
        <label>Status</label>
    ...
    <a href="<?=URL?>index.php/admin/orderList/"><button type="button;border: 1px solid darkblue"
