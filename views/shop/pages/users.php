...
<div class="row">
    <div class="col-3 text-center bg-light">
        ...
        <div><a style="width:130px" href="<?= URL?>index.php/home/changepass" class="btn btn-danger">Đổi Mật Khẩu</a>
        </div>
        <div><a style="width:130px" href="<?= URL ?>index.php/home/cartview" class="btn btn-outline-danger mt-1">Xem đơn
                hàng</a></div>
        <a style="width:130px" class="btn btn-outline-danger" href="<?= URL?>index.php/home/logout"><i
