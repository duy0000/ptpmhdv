...
<div class="h3 mb-5">Sản phẩm theo danh mục</div>
<div class="row">
    <div class="col-10 row">
        ...
        foreach ($data["product_ed"] as $value) {
            ...
            echo "<a href='".URL."index.php/home/details/".$value["id"]."'><img style='width:260px;height:150px' class='proo card-img-top' src='".URL."public/img/" . $value["image"] . "' alt='" . $value["image"] . "'></a>";
