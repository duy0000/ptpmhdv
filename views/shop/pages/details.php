...
<div class="container p-0 chitietsanpham">
    <h3>Thông tin sản phẩm: <?= $product["product_name"] ?></h3>
    <div class="sanpham">
        <div class="hinhanh mt-3">
            <img src="<?= URL ?>public/img/<?= $product["image"] ?>" alt="">
            <div class="mt-4 mb-4">Mô Tả: <?=$product["product_detail"]; ?></div>
        </div>
        <div class="content mt-3">
            <div class="title">
                <div href="#" class="title-name h5">Tên sản phẩm :<?= $product["product_name"] ?></div>
            ...
            <a href="<?=URL?>index.php/home/addcart/<?=$product["id"]?> " class="btn btn-primary themhang">Thêm vào
                giỏ</a>
